...
$sql = "INSERT INTO process(sample_ID, prcs_date, employee_ID, prcs_coating, prcs_position, prcs_rotation, prcs_comment)
		VALUES ('$sampleID','$date','$employee','$coating','$position','$rotation','$comment');";
