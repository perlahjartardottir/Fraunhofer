          ...
          <form id='eqForm' role='form'>
            ...
            while($propRow = mysqli_fetch_array($analysisPropertyResult)){
             ...
             <div class='form-group'>
               ...
               <br>
               <input type='text' id='prop_name' value='".$propRow[1]."' class='col-md-8'>
               <button type='button' class='btn btn-success' onclick='editAnalysisEqProperty(".$propRow[0].",this)'>Edit</button>
