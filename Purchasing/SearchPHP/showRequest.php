...
$sql = "SELECT request_ID, employee_ID, approved_by_employee, request_date, request_description, active, request_supplier, department, timeframe, part_number, quantity
        FROM order_request
