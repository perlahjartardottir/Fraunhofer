...
$sql = "INSERT INTO supplier (supplier_name, supplier_address, supplier_phone, supplier_fax, supplier_email, supplier_contact, supplier_website, supplier_login, supplier_password, supplier_accountNr, supplier_notes)
        VALUES ('$supplier_name', '$supplier_address', '$supplier_phone', '$supplier_fax', '$supplier_email', '$supplier_contact', '$supplier_website', '$supplier_login', '$supplier_password', '$supplier_accountNr', '$supplier_notes');";
