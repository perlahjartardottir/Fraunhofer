...
$sql = "INSERT INTO order_request (employee_ID, timeframe, department, cost_code, request_description, request_date, active, request_supplier, part_number, quantity)
        VALUES ('$employee_ID', '$timeframe', '$department', '$cost_code', '$request_description', CURDATE(), 1, '$request_supplier', '$part_number', '$quantity');";
