      ...
      <form>
        <div class='col-md-12 form-group'>
          ...
          <select id='machine_select' class='form-control'>
            <option value='machine'>All machines</option>
            <option value=''>All machines overall</option>
            <?php
            $sql = "SELECT machine_ID, machine_name
                    FROM machine;";
        ...
        <div class='col-md-12 form-group'>
          <input type='button' value='Apply' class='btn btn-success form-control' onclick='applyMachineFilter()'/>
        </div>
      </form>
    </div>
